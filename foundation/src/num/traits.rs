...
///
/// ```rust
/// use foundation::num::traits::AdditiveArithmetic;
///
...
/// use std::ops::{Add, Mul};
///
/// use foundation::num::traits::Numeric;
///
...
pub trait FloatingPoint: SignedNumeric {
    ...
    ///
    /// ```rust
    /// use foundation::num::traits::FloatingPoint;
    ///
    /// let x = 3.5;
    ...
    ///
    /// ```rust
    /// use foundation::num::traits::{FloatingPoint, FloatingPointRoundingRule};
    ///
    /// let mut x = 2.5;
